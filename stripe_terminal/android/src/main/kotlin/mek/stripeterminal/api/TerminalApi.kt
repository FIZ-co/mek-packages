...
data class TapToPayUxConfigurationTapZoneApi(
    val indicator: TapToPayUxConfigurationTapZoneIndicatorApi?,
    val position: TapToPayUxConfigurationTapZonePositionApi?,
) {
    companion object {
        fun deserialize(
            serialized: List<Any?>,
            ...
            return TapToPayUxConfigurationTapZoneApi(
                indicator = (serialized[0] as Int?)?.let { TapToPayUxConfigurationTapZoneIndicatorApi.values()[it] },
                position = (serialized[1] as List<Any?>?)?.let { TapToPayUxConfigurationTapZonePositionApi.deserialize(it) },
            )
        }
    }
}
